  ...
  return (
    <div className="bg-black">
      ...
      <section className="relative min-h-screen flex flex-col md:flex-row">
        {/* Band Name - Desktop: Centered between sections */}
        <h1 className="hidden md:block absolute left-1/2 top-[40%] -translate-x-1/2 -translate-y-1/2 z-20 text-8xl lg:text-[10rem] font-bold text-black tracking-tight leading-none cursor-pointer transition-all duration-300 hover:text-black/40">
          LILI
        </h1>
        ...
        <div className="md:hidden flex flex-col min-h-screen">
          {/* Mobile Band Name */}
          <div className="bg-white px-6 pt-14 pb-8 text-center">
            <h1 className="text-6xl font-bold text-black tracking-tight leading-none">
              LILI
            </h1>
          </div>
      ...
      <section id="merch" className="relative min-h-screen">
        ...
        <div className="md:hidden relative min-h-screen">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
            {/* Band Name */}
            <h2 className="text-5xl font-bold text-white tracking-tight leading-none mb-8">
              LILI
            </h2>
        ...
        <div className="hidden md:flex flex-row min-h-screen">
          ...
          <div className="w-1/2 bg-black flex flex-col items-center justify-center p-16">
            {/* Band Name */}
            <h2 className="text-6xl lg:text-7xl font-bold text-white tracking-tight leading-none mb-12">
              LILI
            </h2>
